...
function AppContent() {
  ...
  const GITHUB_CLIENT_ID = "Ov23liePInS23d_CHAMA"; // Replace with your actual GitHub Client ID
    ...
    return (
      <div className="login-container" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#05060b', padding: '2rem' }}>
        <div className="login-card animate-slide-up" style={{
          ...
          <div id="googleBtn" style={{ minHeight: '50px', display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}></div>
